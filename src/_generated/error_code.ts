...
export enum ErrorCode {
  ...
  CatalogFamilyNotFound = "catalog_family_not_found",
  CatalogVariantNotFound = "catalog_variant_not_found",
  CatalogVersionNotFound = "catalog_version_not_found",
  CatalogPackageNotFound = "catalog_package_not_found",
  CatalogResourceNotFound = "catalog_resource_not_found",
  CatalogSlugConflict = "catalog_slug_conflict",
  CatalogLifecycleInvalid = "catalog_lifecycle_invalid",
  BillingExportNotFound = "billing_export_not_found",
  CloudCatalogSourceNotFound = "cloud_catalog_source_not_found",
  CloudCatalogMappingNotFound = "cloud_catalog_mapping_not_found",
  CloudCatalogRunNotFound = "cloud_catalog_run_not_found",
  Conflict = "conflict",
  Gone = "gone",
...
export const ERROR_CLASSIFICATION: Record<ErrorCode, ErrorClassification> = {
  ...
  [ErrorCode.AlertRuleNotFound]: { category: "control", retryClass: "never", fallbackEligible: false, suggestedAction: "fix_request" },
  ...
  [ErrorCode.ResourceNotFound]: { category: "catalog", retryClass: "never", fallbackEligible: false, suggestedAction: "fix_request" },
  [ErrorCode.CatalogFamilyNotFound]: { category: "catalog", retryClass: "never", fallbackEligible: false, suggestedAction: "fix_request" },
  [ErrorCode.CatalogVariantNotFound]: { category: "catalog", retryClass: "never", fallbackEligible: false, suggestedAction: "fix_request" },
  [ErrorCode.CatalogVersionNotFound]: { category: "catalog", retryClass: "never", fallbackEligible: false, suggestedAction: "fix_request" },
  [ErrorCode.CatalogPackageNotFound]: { category: "catalog", retryClass: "never", fallbackEligible: false, suggestedAction: "fix_request" },
  [ErrorCode.CatalogResourceNotFound]: { category: "catalog", retryClass: "never", fallbackEligible: false, suggestedAction: "fix_request" },
  [ErrorCode.CatalogSlugConflict]: { category: "catalog", retryClass: "never", fallbackEligible: false, suggestedAction: "fix_request" },
  [ErrorCode.CatalogLifecycleInvalid]: { category: "catalog", retryClass: "never", fallbackEligible: false, suggestedAction: "fix_request" },
  [ErrorCode.BillingExportNotFound]: { category: "catalog", retryClass: "never", fallbackEligible: false, suggestedAction: "fix_request" },
  [ErrorCode.CloudCatalogSourceNotFound]: { category: "catalog", retryClass: "never", fallbackEligible: false, suggestedAction: "fix_request" },
  [ErrorCode.CloudCatalogMappingNotFound]: { category: "catalog", retryClass: "never", fallbackEligible: false, suggestedAction: "fix_request" },
  [ErrorCode.CloudCatalogRunNotFound]: { category: "catalog", retryClass: "never", fallbackEligible: false, suggestedAction: "fix_request" },
  [ErrorCode.Conflict]: { category: "input", retryClass: "never", fallbackEligible: false, suggestedAction: "fix_request" },
  [ErrorCode.Gone]: { category: "input", retryClass: "never", fallbackEligible: false, suggestedAction: "fix_request" },
  [ErrorCode.PayloadTooLarge]: { category: "input", retryClass: "never", fallbackEligible: false, suggestedAction: "fix_request" },

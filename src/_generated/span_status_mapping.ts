...
export const ERROR_ATTRIBUTES = {
  ...
  octomilErrorCode: "octomil.error.code",
  octomilErrorRetryable: "octomil.error.retryable",
  octomilErrorMessage: "octomil.error.message",
} as const;

export const SPAN_EXPECTED_ERRORS: Record<string, string[]> = {

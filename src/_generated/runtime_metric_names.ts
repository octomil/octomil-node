...
export const RUNTIME_METRIC_NAMES = {
  ...
  ttsFrontendCacheClearTotal: "tts.frontend_cache_clear_total",
  ttsFrontendCacheHitTotal: "tts.frontend_cache_hit_total",
  ttsFrontendCacheRejectEmptyTotal: "tts.frontend_cache_reject_empty_total",
  ttsFrontendCacheRejectOversizeTotal: "tts.frontend_cache_reject_oversize_total",
  ...
  whisperChunkFinalCoverageMs: "whisper.chunk_final_coverage_ms",
  whisperChunkSegmentsEmitted: "whisper.chunk_segments_emitted",
  whisperChunkSegmentsKept: "whisper.chunk_segments_kept",
  whisperChunkWindowCount: "whisper.chunk_window_count",
  whisperDecodeMs: "whisper.decode_ms",
  whisperDigestAdmissionOk: "whisper.digest_admission_ok",
  whisperFirstFinalSegmentMs: "whisper.first_final_segment_ms",
  whisperFirstPartialMs: "whisper.first_partial_ms",
